# Hi there, I'm Naufal - aka Naufal Atmaja Faadihilah 👋
## About me:
...
- 📫 Reach me at: naufalatmaja.f@gmail.com
...
#### [Face Anti-Spoofing Challenge | Kaggle Competition](https://github.com/andriilaksono/face-anti-spoofing-detection.git) | `April 2026`
   ...
   - Designed Multi-Zoom Test Time Augmentation (TTA) to eliminate scale mismatch between training and test data
   - Utilized pseudo-labeling and knowledge injection to reduce domain gap and improve generalization
   - Applied threshold shifting strategy to handle class imbalance and dataset bias
...
[![website](./img/linkedin-light.svg)](https://www.linkedin.com/in/naufalatmajafaadihilah/#gh-light-mode-only)
[![website](./img/linkedin-dark.svg)](https://www.linkedin.com/in/naufalatmajafaadihilah/#gh-dark-mode-only)
&nbsp;&nbsp;
[![website](./img/instagram-light.svg)](https://www.instagram.com/naoupal#gh-light-mode-only)
[![website](./img/instagram-dark.svg)](https://www.instagram.com/naoupal#gh-dark-mode-only)
